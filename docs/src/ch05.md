...
[Numeric Comparisons (section)](https://docs.julialang.org/en/v1.9/manual/mathematical-operations/#Numeric-Comparisons)
...
* [`Base.:>` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.:%3E)
* [`Base.:>=` — Function](https://docs.julialang.org/en/v1.9/base/math/#Base.:%3E=)
...
* [`Base.:<` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.:%3C)
* [`Base.:<=` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.:%3C=)
...
[Conditional Evaluation (section)](https://docs.julialang.org/en/v1.9/manual/control-flow/#man-conditional-evaluation)
...
[Conditional evaluation](https://docs.julialang.org/en/v1.9/manual/control-flow/#man-conditional-evaluation)
"ternary operator"
...
* [`&&` - Keyword](https://docs.julialang.org/en/v1.9/base/math/#&&)
...
[Short-Circuit Evaluation (section)](https://docs.julialang.org/en/v1.9/manual/control-flow/#Short-Circuit-Evaluation)
...
* [Random Numbers (section)](hhttps://docs.julialang.org/en/v1.9/stdlib/Random/#Random-Numbers)
* [`Base.Random.rand` - Function](https://docs.julialang.org/en/v1.9/stdlib/Random/#Base.rand)
