...
### ■ 積
* [`Base.prod` — Function](https://docs.julialang.org/en/v1.9/base/collections/#Base.prod)
...
* [`LinearAlgebra.norm` — Function](hhttps://docs.julialang.org/en/v1.9/stdlib/LinearAlgebra/#LinearAlgebra.norm)
...
* [`Statistics.mean` — Function](https://docs.julialang.org/en/v1.9/stdlib/Statistics/#Statistics.mean)
* [`Statistics.stdm` — Function](https://docs.julialang.org/en/v1.9/stdlib/Statistics/#Statistics.stdm)
...
* [`Base.min` — Function](https://docs.julialang.org/en/v1.9/base/math/#Base.min)
* [`Base.max` — Function](https://docs.julialang.org/en/v1.9/base/math/#Base.max)
...
* [... splits one argument into many different arguments in function calls](https://docs.julialang.org/en/v1.9/manual/faq/#...-splits-one-argument-into-many-different-arguments-in-function-calls)
