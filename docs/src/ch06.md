...
[Integers (section)](https://docs.julialang.org/en/v1.9/manual/integers-and-floating-point-numbers/#Integers)
...
[Overflow behavior (section)](https://docs.julialang.org/en/v1.9/manual/integers-and-floating-point-numbers/#Overflow-behavior)
...
* [`Base.bitstring` — Function](https://docs.julialang.org/en/v1.9/base/numbers/#Base.bitstring)
...
* [`Base.rem` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.rem)
* [`Base.div` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.div)
...
* [`Base.mod` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.mod)
* [`Base.fld` - Function](https://docs.julialang.org/en/v1.9/base/math/#Base.fld)
...
* [`Base.Math.mod2pi` — Function](https://docs.julialang.org/en/v1.9/base/math/#Base.Math.mod2pi)
...
除算例外 [Division errors (section)](hhttps://docs.julialang.org/en/v1.9/manual/integers-and-floating-point-numbers/#Division-errors)
...
!!! note
    例外が発生した場合，それを救済する手続きを書いて，プログラムを続行することもできる．だが，この文書の範囲を超えるので，説明しない． → [Exception Handling](https://docs.julialang.org/en/v1.9/manual/control-flow/#Exception-Handling)
